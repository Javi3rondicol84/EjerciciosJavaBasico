...
public class Ej_Parcial_2_Arr_sinsecs {
	...
	public static void main(String [] args) {
		...
		int num = 0;
		int tam = 0;
		int [] arrA = {2,2,2,3,3,3,5,5,5,5,7,7,7,8,8,9,9,11,17,20};
	...
	public static int obtener_pos(int [] arr, int num) {
		int indice = 0;
		while((indice < MAX-1) && (arr[indice] < num)) {
			indice++;
		}
		return indice;
	}
